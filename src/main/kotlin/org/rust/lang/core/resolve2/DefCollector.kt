...
class DefCollector(
    ...
    private fun expandMacro(call: MacroCallInfo, def: MacroDefInfo): ExpansionOutput? {
        ...
        val mixHash = defData.mixHash(callData) ?: return null  // todo
    ...
    private fun recordExpansion(result: ExpansionOutput): Boolean {
        ...
        recordExpansionFileName(mixHash, call)
        return true
    }

    private fun recordExpansionFileName(mixHash: HashCode, call: MacroCallInfo) {
